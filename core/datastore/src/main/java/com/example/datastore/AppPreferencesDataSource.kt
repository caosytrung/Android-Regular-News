...
class AppPreferencesDataSource @Inject constructor(
        ...
        .map {
            UserData(
                ...
                themeBrand = when (it.themeBrand) {
                    ...
                    -> com.example.model.ThemeBrand.ANDROID

                    ThemeBrandProto.THEME_BRAND_ANDROID -> com.example.model.ThemeBrand.ANDROID
                },
                darkThemeConfig = when (it.darkThemeConfig) {
                    ...
                    ->
                        com.example.model.DarkThemeConfig.FOLLOW_SYSTEM

                    DarkThemeConfigProto.DARK_THEME_CONFIG_LIGHT ->
                        com.example.model.DarkThemeConfig.LIGHT

                    DarkThemeConfigProto.DARK_THEME_CONFIG_DARK -> com.example.model.DarkThemeConfig.DARK
                },
    ...
    suspend fun setThemeBrand(themeBrand: com.example.model.ThemeBrand) {
        userPreferences.updateData {
            it.copy {
                this.themeBrand = when (themeBrand) {
                    com.example.model.ThemeBrand.DEFAULT -> ThemeBrandProto.THEME_BRAND_DEFAULT
                    com.example.model.ThemeBrand.ANDROID -> ThemeBrandProto.THEME_BRAND_ANDROID
                }
            }
        }
    }
    ...
    suspend fun setDarkThemeConfig(darkThemeConfig: com.example.model.DarkThemeConfig) {
        userPreferences.updateData {
            it.copy {
                this.darkThemeConfig = when (darkThemeConfig) {
                    ...
                    com.example.model.DarkThemeConfig.LIGHT -> DarkThemeConfigProto.DARK_THEME_CONFIG_LIGHT
                    com.example.model.DarkThemeConfig.DARK -> DarkThemeConfigProto.DARK_THEME_CONFIG_DARK
                }
            }
        }
    }
